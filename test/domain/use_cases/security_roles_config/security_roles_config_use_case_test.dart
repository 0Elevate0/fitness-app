...
import 'security_roles_config_use_case_test.mocks.dart';

@GenerateMocks([SecurityRolesConfigRepository])
void main() {
  TestWidgetsFlutterBinding.ensureInitialized();
  test(
    'when call fetchSecurityRolesConfigData it should be called successfully from SecurityRolesConfigRepository and return SecurityRolesConfigEntity',
    () async {
      // Arrange
      final mockedSecurityRolesConfigRepository =
          MockSecurityRolesConfigRepository();
      ...
      final securityRolesConfigUseCase = SecurityRolesConfigUseCase(
        mockedSecurityRolesConfigRepository,
      );
      ...
      when(
        mockedSecurityRolesConfigRepository.fetchSecurityRolesConfigData(),
      ).thenAnswer((_) async => expectedSecurityRolesConfigEntityResult);

      // Act
      final result = await securityRolesConfigUseCase.invoke();
