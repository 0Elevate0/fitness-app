...
void main() {
  group("validations test", () {
    ...
    test("testing field validation cases", () {
      // Arrange

      // Valid Fields
      final String validFieldCase1 = "Ahmed";

      // Invalid Fields
      final String invalidFieldCase1 = "";
      final String? invalidFieldCase2 = null;

      // Act

      // Valid Fields cases
      final validFieldResult1 = Validations.fieldValidation(
        value: validFieldCase1,
      );

      // Invalid Fields cases
      final invalidFieldResult1 = Validations.fieldValidation(
        value: invalidFieldCase1,
      );
      final invalidFieldResult2 = Validations.fieldValidation(
        value: invalidFieldCase2,
      );

      // Assert
      expect(validFieldResult1, isNull);

      expect(invalidFieldResult1, isNotNull);
      expect(invalidFieldResult2, isNotNull);
    });
  });
}
