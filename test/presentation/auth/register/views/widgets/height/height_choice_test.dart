...
import 'height_choice_test.mocks.dart';
...
void main() {
      ...
      builder: (context, child) {
        return MaterialApp(
          home: BlocProvider<RegisterCubit>.value(
            ...
            child: const Scaffold(body: HeightChoice()),
          ),
        );
      },
    );
  ...
  testWidgets("Verifying HeightChoice Widgets", (tester) async {
    // Act
    ...
    expect(find.text(AppText.cm.tr()), findsOneWidget);
  });
