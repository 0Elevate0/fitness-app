...
import 'years_old_choice_test.mocks.dart';
...
void main() {
      ...
      builder: (context, child) {
        return MaterialApp(
          home: BlocProvider<RegisterCubit>.value(
            ...
            child: const Scaffold(body: YearsOldChoice()),
          ),
        );
      },
    );
  ...
  testWidgets("Verifying YearsOldChoice Widgets", (tester) async {
    // Act
    ...
    expect(find.text(AppText.year.tr()), findsOneWidget);
  });
