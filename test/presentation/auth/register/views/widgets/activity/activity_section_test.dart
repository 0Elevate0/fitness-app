...
import 'activity_section_test.mocks.dart';
...
void main() {
      ...
      builder: (context, child) {
        return MaterialApp(
          home: BlocProvider<RegisterCubit>.value(
            ...
            child: const Scaffold(body: ActivitySection()),
          ),
        );
      },
    );
  ...
  testWidgets("Verifying ActivitySection Widgets", (tester) async {
    // Act
    ...
    expect(find.byType(ActivityChoices), findsOneWidget);
    expect(find.byType(ActivityDoneButton), findsOneWidget);
