...
import 'activity_done_button_test.mocks.dart';
...
void main() {
      ...
      builder: (context, child) {
        return MaterialApp(
          home: BlocProvider<RegisterCubit>.value(
            ...
            child: const Scaffold(body: ActivityDoneButton()),
          ),
        );
      },
    );
  ...
  testWidgets("Verifying ActivityDoneButton Widgets", (tester) async {
    // Act
    ...
    expect(find.text(AppText.done.tr()), findsOneWidget);
  });
