...
import 'fitness_bottom_navigation_bar_test.mocks.dart';
...
void main() {
      ...
      builder: (context, child) {
        return MaterialApp(
          home: BlocProvider<FitnessBottomNavigationCubit>.value(
            ...
            child: const FitnessBottomNavigationBar(),
          ),
        );
      },
    );
  ...
  testWidgets("Verifying FitnessBottomNavigationBar Widgets", (tester) async {
    // Act
