...
import 'edit_profile_details_section_test.mocks.dart';
...
void main() {
        ...
        return MaterialApp(
          home: MultiBlocProvider(
            ...
            child: const Scaffold(
              body: SingleChildScrollView(child: EditProfileDetailsSection()),
            ),
          ),
        );
      },
  ...
  testWidgets("Verifying EditProfileDetailsSection Widgets", (tester) async {
    // Act
    ...
    expect(find.byType(EditProfileGoalsSection), findsOneWidget);
    expect(find.byType(UpdateProfileButton), findsOneWidget);
  });
