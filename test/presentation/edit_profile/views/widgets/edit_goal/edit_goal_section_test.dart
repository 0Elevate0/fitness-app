...
import 'edit_goal_section_test.mocks.dart';
...
void main() {
      ...
      builder: (context, child) {
        return MaterialApp(
          home: BlocProvider<EditProfileCubit>.value(
            ...
            child: const Scaffold(body: EditGoalSection()),
          ),
        );
      },
    );
  ...
  testWidgets("Verifying EditGoalSection Widgets", (tester) async {
    // Act
    ...
    expect(find.byType(EditGoalChoices), findsOneWidget);
