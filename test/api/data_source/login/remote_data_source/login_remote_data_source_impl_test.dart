...
import 'package:fitness_app/api/data_source/login/remote_data_source/login_remote_data_source_impl.dart';
...
void main() {
  ...
  test(
    ...
    () async {
      ...
      final LoginRequestEntity requestEntity = const LoginRequestEntity(
