...
class HeightChoice extends StatelessWidget {
  const HeightChoice({super.key});
      ...
      children: [
        ...
        BlocBuilder<RegisterCubit, RegisterState>(
          builder: (context, state) => NumberPicker(
            value: int.parse(state.selectedHeight),
            minValue: 30,
            maxValue: 300,
            step: 1,
            itemHeight: 62.r,
            ...
            onChanged: (value) => registerCubit.doIntent(
              intent: ChangeSelectedHeightIntent(newSelectedHeight: value),
            ),
